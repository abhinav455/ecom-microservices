...
public class KeyCloakAdminService {
	...
	public String createUser(String token, UserRequest userRequest){
		...
		credential.put("type", userRequest.getPassword());
	...
	private Map<String, Object> getRealmRoleRepresentation(
		...
		String url = keycloakServerUrl + "admin/realms/" + realm + "/clients/" +
				clientUid + "/roles/" + roleName;
	...
	public void assignRealmRoleToUser(String username,
		...
		//add this role representation to user
		HttpHeaders headers = new HttpHeaders();
		headers.setContentType(MediaType.APPLICATION_JSON);
		headers.setBearerAuth(token);
